...
export default function TenantResultsScreen() {
  ...
  const filters = useMemo<TenantFilters>(
    () => ({
      ...
      latitude: getParam(params.latitude) ? Number(getParam(params.latitude)) : undefined,
      longitude: getParam(params.longitude) ? Number(getParam(params.longitude)) : undefined,
      radiusKm: getParam(params.radiusKm) ? Number(getParam(params.radiusKm)) : undefined,
